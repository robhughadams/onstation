...
{
	char szBuffer[128];
	GetDlgItemText(IDC_JOB1,szBuffer,sizeof(szBuffer)-1);
	m_Leg->SetPersonDuty(0,szBuffer);
	GetDlgItemText(IDC_JOB2,szBuffer,sizeof(szBuffer)-1);
	m_Leg->SetPersonDuty(1,szBuffer);
	GetDlgItemText(IDC_JOB3,szBuffer,sizeof(szBuffer)-1);
	m_Leg->SetPersonDuty(2,szBuffer);
	GetDlgItemText(IDC_JOB4,szBuffer,sizeof(szBuffer)-1);
	m_Leg->SetPersonDuty(3,szBuffer);
	GetDlgItemText(IDC_JOB5,szBuffer,sizeof(szBuffer)-1);
	m_Leg->SetPersonDuty(4,szBuffer);
	GetDlgItemText(IDC_JOB6,szBuffer,sizeof(szBuffer)-1);
	m_Leg->SetPersonDuty(5,szBuffer);
	GetDlgItemText(IDC_NAME1,szBuffer,sizeof(szBuffer)-1);
	m_Leg->SetPersonName(0,szBuffer);
	GetDlgItemText(IDC_NAME2,szBuffer,sizeof(szBuffer)-1);
	m_Leg->SetPersonName(1,szBuffer);
	GetDlgItemText(IDC_NAME3,szBuffer,sizeof(szBuffer)-1);
	m_Leg->SetPersonName(2,szBuffer);
	GetDlgItemText(IDC_NAME4,szBuffer,sizeof(szBuffer)-1);
	m_Leg->SetPersonName(3,szBuffer);
	GetDlgItemText(IDC_NAME5,szBuffer,sizeof(szBuffer)-1);
	m_Leg->SetPersonName(4,szBuffer);
	GetDlgItemText(IDC_NAME6,szBuffer,sizeof(szBuffer)-1);
