...
void CMainFrame::SetPaneText(int iPane,LPCSTR szText)
{
	if (m_bCreated)
	{
...
void CMainFrame::OnHelp()
{
	...
	{
		char szBuffer[2048];
		lstrcpyn(szBuffer,csBrowser,sizeof(szBuffer)-1);
		lstrcat(szBuffer," ");
		lstrcat(szBuffer,theApp.m_pszHelpFilePath);
		int iLen=lstrlen(szBuffer)-3;
		lstrcpy(szBuffer+iLen,"htm");
...
{
	AfxMessageBox("Hello Pierre: You can put all of the options in a dialog here.  This is about line 554 of MainFrm.cpp");
}
