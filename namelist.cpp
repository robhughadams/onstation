...
void CNameList::AddName(LPCSTR szName,int iYear)
{						  
...
int CNameList::GetNumberOfNamesForYear(int iYear) const
{
	if (iYear==-1)
	{
...
LPCSTR CNameList::GetName(int iYear,int iIndex,int *iUsed)
{
	if (iYear==-1)
	{
