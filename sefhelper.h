...
class CSEFHelper:public CFileHelper
{
	...
	public:
		...
		BOOL ReadSEFTieIn(LPSTR szName,float *east,float *north,float *elev);
		BOOL ReadSEFSurveyShot(LPSTR szFrom,LPSTR szTo,float* length,float* compass,float* clino,float* up,float* down,float* left,float* right,float* compassback,float* clinoback);
